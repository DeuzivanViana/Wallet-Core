...
export const SignUp = () => {
  ...
  return <Layout className='h-screen flex flex-col justify-center'>
    <form onSubmit={handleSubmit} className='p-6 m-4 flex flex-col gap-4 rounded-md bg-neutral-950 mb-40'>
      ...
      <input name='password1' placeholder='Password' type='password' className='bg-neutral-900 p-4 rounded-lg placeholder-neutral-500 text-neutral-100'/>
      <input name='password2' placeholder='Confirm password' type='password' className='bg-neutral-900 p-4 rounded-lg placeholder-neutral-500 text-neutral-100'/>
